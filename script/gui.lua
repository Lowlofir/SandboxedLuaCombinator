...
function format_code(text, colorize, upd_flow, tracked_pos)
	...
	if colorize or upd_flow then
		...
		local lightblue = {"assert","collectgarbage","dofile","error","getfenv","getmetatable","ipairs","module","next","pairs","pcall","print","rawequal","rawget","rawlen","rawset","require","select","setfenv","setmetatable","tonumber","tostring","type","unpack","xpcall","string","table","math","bit32","coroutine","io","os","debug","package"}
		...
		local pink = {"rednet","greennet","output","delay", 'outputs', 'inputs'}
